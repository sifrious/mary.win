<div class="wra">
    <div class="wra__head">
        <p class="wr-entry"><span class="wr-dot" aria-hidden="true"></span>MEMBERS ENTRANCE</p>
        <h1 class="wra__title">Log <span class="wr-em">in.</span></h1>
        <p class="wra__lede">{{ __('Enter your email and password below to log in.') }}</p>
    </div>
    ...
    <div class="wr-plate">
        <div class="wr-plate__head">
            <span class="wr-label">Your Account</span>
            <span class="wr-plate__bar" aria-hidden="true"></span>
        </div>
        <div class="wr-plate__body">
            <form wire:submit="login" class="wra-form">
                <!-- Email Address -->
                <div class="wr-field">
                ...
                <!-- Password -->
                <div class="wr-field">
                    <div class="wr-field__label">
                        <label for="password">{{ __('Password') }}</label>
                        @if (Route::has('password.request'))
                            <a class="wra-forgot" href="{{ route('password.request') }}" wire:navigate>
                                {{ __('Forgot?') }}
                            </a>
                        @endif
                    </div>
                ...
                <!-- Remember Me -->
                <label class="wr-check-row">
                    <input type="checkbox" wire:model="remember">
                    <span>{{ __('Remember me') }}</span>
                </label>

                <button type="submit" class="wr-btn wr-btn--cta wr-btn--block">{{ __('Log in') }} →</button>
            </form>
        </div>
    </div>
