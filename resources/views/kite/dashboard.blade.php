...
<x-layouts.kite title="Dashboard">
    <div class="k-head">
        <div>
            <h1 class="k-head__title">Welcome back, <span class="wr-em">{{ $user->name }}.</span></h1>
            <p class="k-head__sub">Manage your repositories and explore your codebase vocabulary.</p>
        </div>
        <div class="k-actions">
    ...
    <div class="k-section">
        <div class="k-section__head">
            <h2 class="k-section__title">Your most-used terms</h2>
            <span class="wr-meta">Top functions from your analyzed code</span>
        </div>
        <div class="wr-plate">
            <div class="wr-plate__body">
                <x-kite.term-cloud :terms="$user->getTopTerms(50)" />
            </div>
        </div>
    </div>
    ...
    <div class="k-section">
        <div class="k-section__head">
            <h2 class="k-section__title">Active repositories</h2>
            <span class="wr-meta">{{ $activeRepos->count() }} active</span>
        </div>
